                ...
                <div className="px-1 py-1">
                    <div className="mb-4 flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="mt-1 text-xs text-stone-500 dark:text-stone-400">{format.dateTime(new Date(active.createdAt), { dateStyle: "medium", timeStyle: "short" })}</div>
                        </div>
                    </div>
                    ...
                    <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:justify-end">
                        <Button onClick={close}>{t("acknowledge")}</Button>
