...
const sizeOptions = [
    ...
    { value: "1792x1024", labelKey: "wide", width: 1792, height: 1024 },
    ...
    return (
        <ImageSettingsTheme theme={theme}>
            <div className={className} style={{ color: theme.node.text }} onMouseDown={(event) => event.stopPropagation()}>
                ...
                <SettingGroup title={t("definition")} color={theme.node.muted}>
                ...
                <SettingGroup title={t("size")} color={theme.node.muted}>
