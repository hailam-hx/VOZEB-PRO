    ...
    en: {
        ...
        articles: {
            ...
            account: {
                ...
                title: "Manage plans, credits, and orders",
                summary: "Review profile details, plans, coupons, orders, credit balance, usage, and secure account settings.",
                routeLabel: "Open Profile",
                keywords: ["account", "plan", "credits", "order", "coupon"],
                outcomes: ["Understand balances and usage", "Buy plans through checkout", "Track order and payment status"],
                prepare: "Review the product, benefits, validity, quantity, coupon, and amount due before paying.",
                execute: "Complete payment through the selected channel and return to the original order for status updates.",
                verify: "Check order status, granted benefits, balance history, and usage records after confirmation.",
