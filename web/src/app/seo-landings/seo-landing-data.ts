...
export const SEO_LANDING_DEFINITIONS = {
    "ai-image-generator": {
        ...
        heroNote: "Phù hợp cho creator, đội marketing và shop cần thử nhiều hướng hình ảnh trong cùng một quy trình.",
        ...
        faqs: [
            { question: "Tạo ảnh AI online từ văn bản như thế nào?", answer: "Bạn mô tả chủ thể, bối cảnh và mục đích sử dụng bằng tiếng Việt. HOTX AI hỗ trợ lập kế hoạch, chọn quy trình và mở các tùy chọn phù hợp trước khi tạo ảnh." },
            { question: "Tôi có thể tạo ảnh từ ảnh tham chiếu không?", answer: "Có, nếu bạn có quyền sử dụng ảnh đó. Khả năng tạo ảnh từ ảnh và cách xử lý tham chiếu phụ thuộc vào mô hình đang khả dụng tại thời điểm tạo." },
            { question: "Trình tạo ảnh AI có tự chọn mô hình không?", answer: "Không bắt buộc phải tự chọn. Chế độ lập kế hoạch có thể gợi ý mô hình và tham số tương thích; bạn vẫn có thể dùng lựa chọn được công khai trên giao diện." },
            { question: "Ảnh AI tạo xong có thể tải xuống không?", answer: "Kết quả hoàn tất có thao tác tải xuống và có thể được trích dẫn để tiếp tục tác vụ trong HOTX AI." },
        ],
    ...
    "ai-video-generator": {
        ...
        faqs: [
            {
                question: "Tạo video AI từ văn bản và từ ảnh khác nhau thế nào?",
                answer: "Tạo video từ văn bản bắt đầu bằng mô tả cảnh quay; tạo video từ ảnh dùng hình ảnh có quyền sử dụng làm điểm tham chiếu. Cả hai tùy chọn chỉ xuất hiện khi có mô hình tương thích.",
            },
            { question: "Tạo video từ ảnh có hỗ trợ khung đầu và khung cuối không?", answer: "Có thể khi mô hình hỗ trợ. Hai ảnh phải được bạn chọn rõ vai trò và không dùng cùng một ảnh cho cả hai vị trí." },
            { question: "Có thể tạo video AI cho TikTok và Reels không?", answer: "Bạn có thể chọn tỷ lệ trong danh sách mà mô hình đang hoạt động hỗ trợ; nếu chưa được cấu hình, giao diện giữ lựa chọn tự động." },
            { question: "Nếu tác vụ tạo video AI thất bại thì sao?", answer: "Tác vụ thất bại có thể được thử lại theo đúng bản ghi và cuộc hội thoại ban đầu, giúp giữ nguyên ngữ cảnh làm việc." },
        ],
    ...
    "ai-voice-generator": {
        ...
        faqs: [
            { question: "Tạo giọng nói AI tiếng Việt như thế nào?", answer: "Bạn nhập kịch bản tiếng Việt, sau đó chọn giọng và định dạng đang khả dụng. Chất giọng và ngôn ngữ đầu ra cụ thể phụ thuộc vào hồ sơ giọng và mô hình được dùng." },
            { question: "Giọng đọc AI có thể nghe thử trước khi tải không?", answer: "Có. Kết quả audio hoàn tất có trình phát để nghe lại trước khi bạn tải tệp." },
            { question: "Có thể dùng giọng đã nhân bản để lồng tiếng AI không?", answer: "Có thể dùng hồ sơ giọng của bạn cho tác vụ audio khi hồ sơ đã xử lý xong và bạn có quyền sử dụng mẫu nguồn." },
            { question: "AI Voice Generator hỗ trợ định dạng âm thanh nào?", answer: "Giao diện hiển thị những định dạng được mô hình đang chọn hỗ trợ. HOTX AI không áp một danh sách cố định cho mọi cấu hình." },
        ],
    ...
    "voice-cloning": {
        ...
        faqs: [
            {
                question: "Nhân bản giọng nói AI hoạt động như thế nào?",
                answer: "Bạn tải mẫu âm thanh có quyền sử dụng, xác nhận sự đồng ý và chờ hệ thống xử lý thành hồ sơ giọng. Workspace hiển thị trạng thái trước khi hồ sơ có thể được nghe thử hoặc sử dụng.",
            },
            { question: "Tôi có thể clone giọng nói của người khác không?", answer: "Chỉ khi bạn có sự đồng ý và quyền sử dụng phù hợp từ chủ thể giọng nói. Không tải lên mẫu thu trái phép hoặc dùng để mạo danh." },
            { question: "Hồ sơ voice cloning có thể nghe thử và xóa không?", answer: "Có. Khu vực quản lý hỗ trợ nghe thử hồ sơ đã sẵn sàng, đổi tên và xóa hồ sơ của tài khoản." },
            { question: "Hồ sơ giọng nói AI được dùng ở đâu?", answer: "Hồ sơ sẵn sàng có thể được chọn trong tác vụ tạo âm thanh khi năng lực đang hoạt động hỗ trợ lựa chọn đó." },
        ],
    ...
    "ai-short-drama": {
        ...
        faqs: [
            { question: "Tạo phim ngắn AI từ kịch bản đến video như thế nào?", answer: "Bạn tổ chức dự án, tài sản và kịch bản, sau đó đi qua các bước duyệt nội dung, tạo storyboard và sản xuất từng cảnh quay." },
            { question: "AI có hỗ trợ tạo nhân vật và storyboard không?", answer: "Workspace quản lý nhân vật, bối cảnh và các tài sản cấp dự án, đồng thời tổ chức storyboard trước khi tạo từng cảnh quay." },
            ...
            { question: "Nếu một cảnh quay AI thất bại thì xử lý thế nào?", answer: "Workspace hiển thị mục thất bại và nguyên nhân chặn để thử lại đúng shot hoặc bước liên quan, không cần tạo lại toàn bộ dự án." },
        ],
    ...
    "ai-agent": {
        ...
        faqs: [
            { question: "AI Agent là gì?", answer: "AI Agent trong HOTX AI tiếp nhận brief tiếng Việt, hỗ trợ chọn quy trình và điều phối tác vụ hình ảnh, video hoặc âm thanh theo năng lực đang khả dụng." },
            { question: "AI Agent có thể tạo ảnh, video và âm thanh không?", answer: "Có thể bắt đầu các loại tác vụ này trong cùng workspace. Mỗi kết quả được tạo theo năng lực và tham số tương thích của loại media đó." },
            { question: "AI Agent sáng tạo nội dung có tự chọn mô hình không?", answer: "Agent có thể hỗ trợ chọn mô hình và tham số phù hợp từ danh mục được cấu hình. Lựa chọn chỉ dựa trên năng lực thực tế đang khả dụng." },
            { question: "Có thể tiếp tục tác vụ AI Agent sau khi đóng trang không?", answer: "Hội thoại và tác vụ được gắn với tài khoản để bạn có thể mở lại, theo dõi trạng thái và tiếp tục khi phù hợp." },
        ],
