...
export function browserIconHref(site: Pick<SiteSettings, "iconUrl" | "logoUrl">) {
    ...
    if (directIconUrl && (directIconUrl !== DEFAULT_SITE_ICON_URL || logoUrl === DEFAULT_SITE_LOGO_URL)) return directIconUrl;
    return logoUrl || directIconUrl || DEFAULT_SITE_ICON_URL;
}
