...
const POSTGRES_TABLES = [
    ...
    "top_up_presets",
    "top_up_promotions",
    "top_up_coupon_templates",
    "top_up_user_coupons",
    "top_up_orders",
    "top_up_payments",
    "top_up_payment_events",
    "top_up_refunds",
    "top_up_reconciliation_runs",
    "top_up_reconciliation_rows",
    "referral_programs",
    "referral_codes",
...
const POSTGRES_SCHEMA_OBJECTS = [
    ...
    "provider_usage_attempts_hold_idx",
    "provider_usage_attempts_upstream_idx",
    "top_up_presets_enabled_idx",
    "top_up_promotions_active_idx",
    "top_up_user_coupons_user_idx",
    "top_up_orders_user_created_idx",
    ...
    "top_up_refunds_provider_refund_idx",
    "top_up_reconciliation_runs_provider_file_hash_idx",
    ...
    "top_up_reconciliation_runs_created_idx",
    "top_up_reconciliation_runs_provider_created_idx",
    "top_up_reconciliation_rows_run_idx",
    "top_up_reconciliation_rows_issue_codes_gin_idx",
    ...
    "agent_runs_user_updated_idx",
    "agent_tasks_claim_due_idx",
    "agent_tasks_run_status_idx",
    "agent_tool_calls_task_idx",
    "agent_tool_calls_generation_idx",
    ...
    "wallet_holds_set_updated_at",
    "provider_usage_attempts_set_updated_at",
    "top_up_presets_set_updated_at",
    "top_up_promotions_set_updated_at",
    "top_up_coupon_templates_set_updated_at",
    "top_up_user_coupons_set_updated_at",
    "top_up_orders_set_updated_at",
    "top_up_payments_set_updated_at",
    "top_up_payment_events_set_updated_at",
    "top_up_refunds_set_updated_at",
    "top_up_reconciliation_runs_set_updated_at",
    "top_up_reconciliation_rows_set_updated_at",
