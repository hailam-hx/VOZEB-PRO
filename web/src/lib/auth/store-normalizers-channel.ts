...
export function normalizeSystemChannelAdvancedConfig(config: Partial<SystemChannelAdvancedConfig> | undefined): SystemChannelAdvancedConfig | undefined {
    ...
    return {
        ...
        ...(normalizeApiPath(config.catalogPath) ? { catalogPath: normalizeApiPath(config.catalogPath) } : {}),
        ...(normalizeApiPath(config.deletePath) ? { deletePath: normalizeApiPath(config.deletePath) } : {}),
