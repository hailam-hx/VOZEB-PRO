...
export default defineConfig({
    ...
    projects: [
        ...
        { name: "chromium", testMatch: [/(?:admin-points|all-pages|canvas|commerce|core|creative-video-result|home|i18n|responsive|seo-landings|voices)\.spec\.ts/], dependencies: ["setup"], use: { ...devices["Desktop Chrome"], storageState } },
        {
            name: "mobile-390",
            testMatch: /(?:admin-points|all-pages|commerce|creative-video-result|home|i18n|responsive|seo-landings|voices)\.spec\.ts/,
            dependencies: ["setup"],
