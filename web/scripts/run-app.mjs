...
const runtime = generationRuntimeEnvironment({ environment: { ...process.env, VOZEB_PRO_DATA_DIR: resolveSourceDevelopmentDataDir(process.env.VOZEB_PRO_DATA_DIR, webRoot) }, allowEphemeralToken: true });
