---
title: 页面功能图册
description: HOTX AI 用户端、公开页和管理后台的主要页面截图与功能说明
---
...
<div className="grid gap-6 lg:grid-cols-2">
  ...
  <figure>
    ...
    <figcaption>
      <strong>个人中心</strong>
      ：管理资料、安全、统一积分、消费记录、充值和订单，并支持个人数据导出与注销申请。
    </figcaption>
  </figure>
  <figure>
    <img
    ...
    />
    <figcaption>
      <strong>充值中心</strong>：选择 VND
      充值预设或自定义金额，核对服务器报价、支付方式和订单摘要。
    </figcaption>
  </figure>
  <figure>
    <img
...
<div className="grid gap-6 lg:grid-cols-2">
  ...
  <figure>
    ...
    <figcaption>
      <strong>充值与定价</strong>
      ：维护充值预设、客户汇率、逻辑售价、上游绑定成本和供应商单位换算。
    </figcaption>
  </figure>
  <figure>
    <img
  ...
  <figure>
    ...
    <figcaption>
      <strong>初始化配置</strong>
      ：按站点、模型、充值定价、支付、邮件、存储和备份顺序完成上线检查。
    </figcaption>
  </figure>
</div>
